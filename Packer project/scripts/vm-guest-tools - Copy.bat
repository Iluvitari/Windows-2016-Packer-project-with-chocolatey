...
if exist "C:\Users\Project\windows.iso" (
    move /Y C:\Users\Project\windows.iso C:\Windows\Temp
)
...
:parallels
if exist "C:\Users\Project\prl-tools-win.iso" (
	move /Y C:\Users\Project\prl-tools-win.iso C:\Windows\Temp
